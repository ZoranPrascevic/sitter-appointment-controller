(function ($) {
    "use strict";
    initDataTable('.table-table_appointment_channel', admin_url + 'appointment/table_appointment_channel');
    init_appointment_channel();
})(jQuery);
function init_appointment_channel(id) {
    load_small_table_item_channel(id, '#campaign_sm_view', 'rec_channel_id', 'appointment/get_appointment_channel_data_ajax', '.campaign_sm');
}
