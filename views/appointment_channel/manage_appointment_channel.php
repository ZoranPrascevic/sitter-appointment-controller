         ...
         <div class="col-md-12" id="small-table">
            <div class="panel_s">
               <div class="panel-body">
                  ...
                  <a href="<?php echo admin_url('appointment/add_edit_appointment_channel'); ?>" class="btn btn-info pull-left display-block"><?php echo _l('new'); ?></a>
