                  ...
                  <div class="panel_s">
                     <div class="panel-body">
                        ...
                        <div class="modal-body">
                           <div class="horizontal-scrollable-tabs preview-tabs-top mb-2">
                              ...
                              <div class="horizontal-tabs">
                                 <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
                                    ...
                                    <li role="presentation" class="<?php if (isset($tab) && $tab = 'walking_process') {
                                                                        echo 'active';
                                                                     } ?>">
                           ...
                           <?php echo form_open_multipart(admin_url('appointment/add_edit_appointment_channel'), array('class' => 'appointment-channel-add-edit', 'autocomplete' => 'off')); ?>

                           <div class="tab-content">
                              <?php if (isset($appointment_channel_id)) { ?>
                                 <?php echo form_hidden('appointment_channel_id', $appointment_channel_id); ?>
                              <?php } ?>
                              ...
                              <div role="tabpanel" class="tab-pane active" id="form_infomation">
                                 <div class="row mt-5">
                                    <div class="col-md-6">
                                       ...
                                       <!-- appointment plan approval -->
                                       <?php $rec_campaign_id = (isset($form->rec_campaign_id) ? $form->rec_campaign_id : ''); ?>
                                       <?php echo render_select('rec_campaign_id', $list_rec_campaign, array('cp_id', 'campaign_name'), 'appointment_campaign', $rec_campaign_id); ?>
                                    ...
                                    <div class="col-md-6">
                                       ...
                                       $status = [
                                          ...
                                          '3' => ['id' => '3', 'name' => _l('walking')],
                                          '4' => ['id' => '4', 'name' => _l('won_walking')],
                                       ...
                                       <div class="checkbox checkbox-primary">
                                          ...
                                          <label for="notify_lead_imported"><?php echo _l('notify_when_new_pet_afters'); ?></label>
                                       </div>
                                       <div class="select-notification-settings<?php if (isset($form) && $form->notify_lead_imported == '0') {
                                          ...
                                          <div id="staff_notify" class="<?php if (isset($form->notify_type) && ($form->notify_type != 'specific_staff')) {
                                                                           echo 'd-none';
                                                                        } ?>">
                                          ...
                                          <div id="role_notify" class="<?php if (isset($form->notify_type) && ($form->notify_type != 'roles')) {
                                                                           echo 'd-none';
                                                                        } else {
                                                                           echo 'hide';
                                                                        } ?>">
                              ...
                              <!-- form_builder start -->
                              <div role="tabpanel" class="tab-pane <?php if (isset($tab) && $tab = 'form_builder') {
                                                                        echo 'active';
                                                                     } ?> " id="form_builder">
                              ...
                              <?php if (has_permission('appointment', '', 'create')) { ?>
                                 <div class="row">
                                    <div class="col-md-12">
...
<?php require 'modules/appointment/assets/js/channel_detail_js.php'; ?>
