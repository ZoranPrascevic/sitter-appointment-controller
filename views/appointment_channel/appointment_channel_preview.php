          ...
          <ul class="list-group">
              ...
              <table class="table border table-striped margin-top-0">
                <tbody>
                  <tr class="project-overview">
                    ...
                    <td><?php echo html_entity_decode($appointment_channel->r_form_name); ?></td>
                  </tr>
                  <tr class="project-overview">
                  ...
                  <?php
                  $rec_campaign = $this->appointment_model->get_rec_campaign($appointment_channel->rec_campaign_id);
                  ...
                  $_data = ($arr_status[$appointment_channel->lead_status]);

                  ?>
                  <tr class="project-overview">
                    <td class="bold"><?php echo _l('status_after_submit_form'); ?></td>
                    <td><?php echo get_status_pet_after($appointment_channel->lead_status);; ?></td>
                  </tr>
            ...
            <p><b>Form url:</b>
              <span class="label label-default">
                <a href="<?php echo site_url('appointment/forms/wtl/' . $appointment_channel->form_key); ?>" target="_blank"><?php echo site_url('appointment/forms/wtl/' . $appointment_channel->form_key); ?></a>
              </span>
            </p>
            <hr>
            ...
            <textarea class="form-control width-height-738-66" rows="1">&lt;iframe width="600" height="850" src="<?php echo site_url('appointment/forms/wtl/' . $appointment_channel->form_key); ?>" frameborder="0" allowfullscreen&gt;&lt;/iframe&gt;</textarea>
