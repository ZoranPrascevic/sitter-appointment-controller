            ...
            <div class="panel-body">
               <div class="widget" id="widget-<?php echo basename(__FILE__, ".php"); ?>" data-name="<?php echo _l('hrm'); ?>">
                  <div class="row">
                     <div class="col-md-12">
                        <div class="col-md-6">
                           <p class="text-dark text-uppercase bold"><?php echo _l('appointment_dashboard'); ?></p>
                        </div>
                     ...
                     <div class="col-md-6">
                        <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6">
                           <div class="top_stats_wrapper minheight85">
                              <a class="text-success mbot15">
                                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm glyphicon glyphicon-edit"></i> <?php echo _l('pet_afters_need_to_recruit'); ?>
                                 </p>
                                 <span class="pull-right bold no-mtop fontsize24"><?php echo html_entity_decode($cp_count['pet_after_need']); ?></span>
                              </a>
                              <div class="clearfix"></div>
                              <div class="progress no-margin progress-bar-mini">
                                 <div class="progress-bar progress-bar-success no-percent-text not-dynamic width100" role="progressbar" aria-valuenow="<?php echo html_entity_decode($cp_count['pet_after_need']); ?>" aria-valuemin="0" aria-valuemax="<?php echo html_entity_decode($cp_count['pet_after_need']); ?>" data-percent="100%">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6">
                           <div class="top_stats_wrapper minheight85">
                              <a class="text mbot15">
                                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm glyphicon glyphicon-edit"></i> <?php echo _l('recruited_pet_after'); ?>
                                 </p>
                              ...
                              <div class="progress no-margin progress-bar-mini">
                                 ...
                                 ?>
                                 <div class="progress-bar progress-bar no-percent-text not-dynamic" role="progressbar" aria-valuenow="<?php echo html_entity_decode($cp_count['recruited']); ?>" aria-valuemin="0" aria-valuemax="<?php echo html_entity_decode($cp_count['pet_after_need']); ?>" style=" width: <?php echo html_entity_decode($percentage); ?>%" data-percent="<?php echo html_entity_decode($percentage); ?>%">
                                 </div>
                              </div>
                           </div>
                        </div>
                        <div class="quick-stats-invoices col-xs-12 col-md-6 col-sm-6">
                           <div class="top_stats_wrapper minheight85">
                              <a class="text-info mbot15">
                                 <p class="text-uppercase mtop5 minheight35"><i class="hidden-sm glyphicon glyphicon-envelope"></i> <?php echo _l('upcoming_walking'); ?>
                                 </p>
                     ...
                     <div class="col-md-6">
                        <p class="bold margintop15-color"><?php echo _l('upcoming_walking'); ?></p>
                        ...
                        <table class="table dt-table">
                           ...
                           <tbody>
                              <?php foreach ($upcoming_walking as $intv) { ?>
                                 <tr>
                                    ...
                                    <td><?php echo _d($intv['walking_day']); ?></td>
                                 </tr>
                              <?php } ?>
                           </tbody>
                        </table>
...
<?php init_tail(); ?>
<?php require('modules/appointment/assets/js/dashboard_js.php'); ?>