			...
			<div class="panel-body">
				<div class="col-md-12">
					<h4 class="bold col-md-5">
						<?php echo '#' . $pet_after->pet_after_code . ' - ' . $pet_after->pet_after_name; ?>
					</h4>
					...
					<ul id="popup_approval" class="dropdown-menu dropdown-menu-right min-width-440">
						<li>
							<br>
							<div class="col-md-12">
								<a href="#" onclick="walking(); return false;" class="btn btn-info pull-right display-block mright5 walking-background"><i class="fa fa-microphone"></i><?php echo ' ' . _l('walking'); ?></a>
					...
					<a href="#" onclick="send_mail_pet_after(); return false;" class="btn btn-info pull-right display-block mright5"><i class="fa fa-envelope"></i><?php echo ' ' . _l('send_mail'); ?></a>

					<a href="#" class="btn btn-warning pull-right mright5" data-toggle="modal" data-target="#pet_after_rating"><i class="fa fa-star"></i><?php echo ' ' . _l('rate_pet_after'); ?></a>
					<div class="col-md-3 pull-right">
						<select name="change_status" id="change_status" onchange="change_status_pet_after(this,<?php echo html_entity_decode($pet_after->id); ?>); return false;" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('change_status_to'); ?>">
							<option value=""></option>
							<option value="1" class="<?php if ($pet_after->status == 1) {
															echo 'hide';
														} ?>"><?php echo _l('application'); ?></option>
							<option value="2" class="<?php if ($pet_after->status == 2) {
															echo 'hide';
														} ?>"><?php echo _l('potential'); ?></option>
							<option value="3" class="<?php if ($pet_after->status == 3) {
															echo 'hide';
														} ?>"><?php echo _l('walking'); ?></option>
							<option value="4" class="<?php if ($pet_after->status == 4) {
															echo 'hide';
														} ?>"><?php echo _l('won_walking'); ?></option>
							<option value="5" class="<?php if ($pet_after->status == 5) {
															echo 'hide';
														} ?>"><?php echo _l('send_offer'); ?></option>
							<option value="6" class="<?php if ($pet_after->status == 6) {
															echo 'hide';
														} ?>"><?php echo _l('elect'); ?></option>
							<option value="7" class="<?php if ($pet_after->status == 7) {
															echo 'hide';
														} ?>"><?php echo _l('non_elect'); ?></option>
							<option value="8" class="<?php if ($pet_after->status == 8) {
															echo 'hide';
														} ?>"><?php echo _l('unanswer'); ?></option>
							<option value="9" class="<?php if ($pet_after->status == 9) {
															echo 'hide';
														} ?>"><?php echo _l('transferred'); ?></option>
							<option value="10" class="<?php if ($pet_after->status == 10) {
															echo 'hide';
				...
				<div class="col-md-12">
						...
						<div class="horizontal-tabs">
							<ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
								...
								<li role="presentation">
									<a href="#history_appointment" aria-controls="history_appointment" role="tab" data-toggle="tab" aria-controls="history_appointment">
										<i class="fa fa-calendar"></i>&nbsp;<?php echo _l('history_appointment'); ?>
									</a>
								</li>
								<li role="presentation">
					...
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane active" id="detail">
								...
								<div class="container">
									<div class="picture-container pull-left">
										<div class="picture pull-left">
											<img class="width-height-160" src="<?php if (isset($pet_after->avar)) {
								...
								<table class="table border table-striped margin-top-0">
									<tbody>
										<tr class="project-overview">
											...
											<td><?php echo html_entity_decode($pet_after->pet_after_name); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('gender'); ?></td>
											<td><?php echo _l($pet_after->gender); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('nation'); ?></td>
											<td><?php echo html_entity_decode($pet_after->nation); ?></td>
										</tr>

										<tr class="project-overview">
											<td class="bold"><?php echo _l('marital_status'); ?></td>
											<td><?php echo _l($pet_after->marital_status); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('height'); ?></td>
											<td><?php echo html_entity_decode($pet_after->height); ?></td>
										</tr>
							...
							<div class="col-md-5 padding-left-right-0">
								<table class="table border table-striped margin-top-0">
									<tbody>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('pet_after_code'); ?></td>
											<td><?php echo html_entity_decode($pet_after->pet_after_code); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold" width="30%"><?php echo _l('birthday'); ?></td>
											<td><?php echo _d($pet_after->birthday); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('nationality'); ?></td>
											<td><?php echo html_entity_decode($pet_after->nationality); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('religion'); ?></td>
											<td><?php echo html_entity_decode($pet_after->religion); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('weight'); ?></td>
											<td><?php echo html_entity_decode($pet_after->weight); ?></td>
										</tr>
								...
								<table class="table border table-striped margin-top-0">
									<tbody>
										<tr class="project-overview">
											...
											<td><?php
												$cp = get_rec_campaign_hp($pet_after->rec_campaign);
												$datas = '';
												if (isset($cp)) {
													$datas = '<a href="' . admin_url('appointment/appointment_campaign/' . $cp->cp_id) . '">' . $cp->campaign_code . ' - ' . $cp->campaign_name . '</a>';
												}
										...
										<tr class="project-overview">
											...
											<td><?php echo _d($pet_after->date_add); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('identification'); ?></td>
											<td><?php echo html_entity_decode($pet_after->identification); ?></td>
										</tr>

										<tr class="project-overview">
											<td class="bold"><?php echo _l('birthplace'); ?></td>
											<td><?php echo _l($pet_after->birthplace); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('resident'); ?></td>
											<td><?php echo html_entity_decode($pet_after->resident); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('phonenumber'); ?></td>
											<td><?php echo html_entity_decode($pet_after->phonenumber); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('skype'); ?></td>
											<td><?php echo html_entity_decode($pet_after->skype); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('introduce_yourself'); ?></td>
											<td><?php echo html_entity_decode($pet_after->introduce_yourself); ?></td>
										</tr>
									</tbody>
								</table>
							</div>
								...
								<table class="table border table-striped margin-top-0">
									<tbody>
										<tr class="project-overview">
											...
											<td><?php echo get_status_pet_after($pet_after->status); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('desired_walk_time'); ?></td>
											<td><?php echo app_format_money($pet_after->desired_walk_time, ''); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('days_for_identity'); ?></td>
											<td><?php echo _d($pet_after->days_for_identity); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('home_town'); ?></td>
											<td><?php echo html_entity_decode($pet_after->home_town); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('current_accommodation'); ?></td>
											<td><?php echo html_entity_decode($pet_after->current_accommodation); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('email'); ?></td>
											<td><?php echo html_entity_decode($pet_after->email); ?></td>
										</tr>
										<tr class="project-overview">
											<td class="bold"><?php echo _l('facebook'); ?></td>
											<td><?php echo html_entity_decode($pet_after->facebook); ?></td>
										</tr>
										<tr class="project-overview">
											<td> &nbsp;</td>
											<td></td>
							...
							<?php if (count($pet_after->work_experience) > 0) { ?>
								<table class="table dt-table margin-top-0">
									<thead>
										<th><?php echo _l('from_date'); ?></th>
										<th><?php echo _l('to_date'); ?></th>
										<th><?php echo _l('walker'); ?></th>
										<th><?php echo _l('position'); ?></th>
										<th><?php echo _l('contact_walker'); ?></th>
										<th><?php echo _l('walk_time'); ?></th>
										<th><?php echo _l('reason_quitwork'); ?></th>
										<th><?php echo _l('sitter_description'); ?></th>
									</thead>
									<tbody>
										<?php foreach ($pet_after->work_experience as $we) { ?>
											<tr class="project-overview">
												<td><?php echo _d($we['from_date']); ?></td>
												<td><?php echo _d($we['to_date']); ?></td>
												<td><?php echo html_entity_decode($we['walker']); ?></td>
												<td><?php echo html_entity_decode($we['position']); ?></td>
												<td><?php echo html_entity_decode($we['contact_walker']); ?></td>
												<td><?php echo html_entity_decode($we['walk_time']); ?></td>
												<td><?php echo html_entity_decode($we['reason_quitwork']); ?></td>
												<td><?php echo html_entity_decode($we['sitter_description']); ?></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
							...
							<hr class="other_infor-hr" />
							<?php if (count($pet_after->literacy) > 0) { ?>
								<table class="table dt-table margin-top-0">
									<thead>
										<th><?php echo _l('from_date'); ?></th>
										<th><?php echo _l('to_date'); ?></th>
									...
									<tbody>
										<?php foreach ($pet_after->literacy as $we) { ?>
											<tr class="project-overview">
							...
							<hr class="other_infor-hr" />
							<?php if (count($pet_after->family_infor) > 0) { ?>
								<table class="table dt-table margin-top-0">
									<thead>
									...
									<tbody>
										<?php foreach ($pet_after->family_infor as $we) { ?>
											<tr class="project-overview">
						...
						<div role="tabpanel" class="tab-pane" id="history_appointment">
							<p class="bold other_infor-style"><?php echo _l('campaign_has_joined'); ?></p>
							<hr class="other_infor-hr" />
							<?php if ($pet_after->rec_campaign > 0) {
							?>
								<table class="table dt-table margin-top-0">
									<thead>
										...
										<th><?php echo _l('desired_walk_time'); ?></th>
									</thead>
									<tbody>
							...
							<p class="bold other_infor-style"><?php echo _l('walking_schedule'); ?></p>
							<hr class="other_infor-hr" />
							<table class="table dt-table margin-top-0">
								<thead>
									<th><?php echo _l('add_from'); ?></th>
									<th><?php echo _l('walking_schedules_name'); ?></th>
									<th><?php echo _l('time'); ?></th>
									<th><?php echo _l('walking_day'); ?></th>
									<th><?php echo _l('appointment_campaign'); ?></th>
									<th><?php echo _l('walkinger'); ?></th>
									<th><?php echo _l('date_add'); ?></th>
								</thead>
								<tbody>
									<?php foreach ($list_walking as $li) {
									?>
										<tr>
											<td>
												<?php
											...
											<td><?php echo _d($li['walking_day']); ?></td>
											<td><?php
							...
							?>
								<table class="table dt-table margin-top-0">
									...
									<tbody>
										...
										<?php foreach ($pet_after->care as $care) {
										?>
											<tr class="project-overview">
						...
						<div role="tabpanel" class="tab-pane" id="capacity_profile">
							...
							<div class="row col-md-12">
								<p class="bold other_infor-style"><?php echo _l('pet_after_evaluation'); ?></p>
								<hr class="other_infor-hr" />
							</div>
						...
						<div role="tabpanel" class="tab-pane" id="attachment">
							<div id="pet_after_pv_file">
								<br>
								<?php
								$file_html = '';
								if (count($pet_after->file) > 0) {

									foreach ($pet_after->file as $f) {
										$href_url = site_url(appointment_PATH . 'pet_after/files/' . $f['rel_id'] . '/' . $f['file_name']) . '" download';
										if (!empty($f['external'])) {
											$href_url = $f['external_link'];
										}
										$file_html .= '<div class="mbot15 row inline-block full-width" data-attachment-id="' . $f['id'] . '">
					              <div class="col-md-8">
					                 <a name="preview-ase-btn" onclick="preview_pet_after_btn(this); return false;" rel_id = "' . $f['rel_id'] . '" id = "' . $f['id'] . '" href="Javascript:void(0);" class="mbot10 btn btn-success pull-left margin-right-5" data-toggle="tooltip" title data-original-title="' . _l('preview_file') . '"><i class="fa fa-eye"></i></a>
					              ...
					              <div class="col-md-4 text-right">';
										if ($f['staffid'] == get_staff_user_id() || is_admin()) {
											$file_html .= '<a href="#" class="text-danger" onclick="delete_pet_after_attachment(' . $f['id'] . '); return false;"><i class="fa fa-times"></i></a>';
										}
										$file_html .= '</div></div>';
									}
									$file_html .= '<hr />';
							...
							<div id="pet_after_file_data"></div>
						</div>
...
<div class="modal fade" id="care_modal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<?php echo form_open_multipart(admin_url('appointment/care_pet_after'), array('id' => 'care_pet_after-form')); ?>
		<div class="modal-content width-100">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						<?php $attr = [];
						$attr = ['disabled' => "true"];
						echo render_input('pet_after', 'pet_after', $pet_after->pet_after_code . ' - ' . $pet_after->pet_after_name, 'text', $attr);

						echo form_hidden('pet_after', $pet_after->id);
						?>
					</div>
					<div class="col-md-6">
			...
			<div class="modal-footer">
				...
				<button id="sm_btn" type="submit" onclick="submit_care_pet_after(); return false;" class="btn btn-info"><?php echo _l('submit'); ?></button>
			</div>
		</div><!-- /.modal-content -->
		<?php echo form_close(); ?>
	</div><!-- /.modal-dialog -->
...
<div class="modal fade" id="mail_modal" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<?php echo form_open_multipart(admin_url('appointment/send_mail_pet_after'), array('id' => 'mail_pet_after-form')); ?>
		<div class="modal-content width-100">
			<div class="modal-header">
			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12">
						<?php echo render_input('email', 'email', $pet_after->email); ?>
					</div>
...
<div class="modal fade" id="pet_after_rating" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content width-100">
			<div class="modal-header">
				<button group="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">
					<span><?php echo _l('rate_pet_after'); ?></span>
				</h4>
			</div>
			<?php echo form_open('admin/appointment/rating_pet_after', array('id' => 'rating-modal')); ?>
			<?php echo form_hidden('pet_after', $pet_after->id); ?>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<?php if ($evaluation != '') {
			...
			<div class="modal-footer">
				...
				<button group="submit" onclick="submit_rating_pet_after(); return false;" class="btn btn-info"><?php echo _l('submit'); ?></button>
				<?php echo form_close(); ?>
			</div>
		</div>
	</div>
...
<?php init_tail(); ?>
<?php require 'modules/appointment/assets/js/pet_after_detail_js.php'; ?>
</body>
