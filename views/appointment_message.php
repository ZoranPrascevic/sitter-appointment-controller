      ...
      <div class="col-md-12" id="small-table">
        <div class="panel_s">
          <div class="panel-body">
            <?php echo form_hidden('message_id', $message_id); ?>
            <div class="row">
              <div class="col-md-12">
            ...
            <div class="row">
              <div class="col-md-3  ">
                <?php if (has_permission('appointment', '', 'create') || is_admin()) { ?>
                  <a href="#" onclick="new_message(); return false;" class="btn btn-info pull-left display-block">
                    <?php echo _l('new_message'); ?>
                  </a>
                <?php } ?>
              </div>
              <div class=" col-md-3">
                <select name="sitter_available_time_filter[]" id="sitter_available_time_filter" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('filter_by_sitter_available_time'); ?>">

                  <?php foreach ($sitter_available_times as $s) { ?>
                    <option value="<?php echo html_entity_decode($s['sitter_available_timeid']); ?>"><?php echo html_entity_decode($s['name']); ?></option>
                  <?php } ?>
                </select>
              </div>
              <div class=" col-md-3">
              ...
              <div class=" col-md-2">
                <select name="status_filter[]" id="status_filter" class="selectpicker" data-live-search="true" multiple="true" data-width="100%" data-none-selected-text="<?php echo _l('filter_by_status'); ?>">
                  ...
                  <option value="1"><?php echo _l('message'); ?></option>
              ...
              <div class="col-md-1 pull-right">
                <a href="#" class="btn btn-default pull-right btn-with-tooltip toggle-small-view hidden-xs" onclick="toggle_small_view_message('.message_sm','#message_sm_view'); return false;" data-toggle="tooltip" title="<?php echo _l('invoices_toggle_table_tooltip'); ?>"><i class="fa fa-angle-double-left"></i></a>
              </div>
            </div>
            <br><br>
            <?php render_datatable(array(
              ...
              _l('position'),
              _l('form_of_work'),
              _l('sitter_available_time'),
              _l('amount_recruiment'),
              _l('status')
            ), 'table_rec_message', ['message_sm' => 'message_sm']); ?>
          </div>
        </div>
      </div>
      <div class="col-md-7 small-table-right-col">
        <div id="message_sm_view" class="hide">
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade" id="appointment_message" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <?php echo form_open_multipart(admin_url('appointment/message'), array('id' => 'appointment-message-form')); ?>
    <div class="modal-content width-125">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title">
          <span class="edit-title"><?php echo _l('edit_message'); ?></span>
          <span class="add-title"><?php echo _l('new_message'); ?></span>
        </h4>
      </div>
      <div class="modal-body">
          ...
          <div class="horizontal-tabs">
            <ul class="nav nav-tabs nav-tabs-horizontal mbot15" role="tablist">
              ...
              <li role="presentation">
                <a href="#pet_after_request" aria-controls="pet_after_request" role="tab" data-toggle="tab" aria-controls="pet_after_request">
                  <i class="fa fa-group"></i>&nbsp;<?php echo _l('pet_after_request'); ?>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="general_infor">
            <div class="col-md-12">
              <?php echo render_input('pet_name', 'pet_name', ''); ?>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <label for="sitter_available_time"><?php echo _l('sitter_available_time'); ?></label>
              <select name="sitter_available_time" id="sitter_available_time" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                <option value=""></option>
                <?php foreach ($sitter_available_times as $s) { ?>
                  <option value="<?php echo html_entity_decode($s['sitter_available_timeid']); ?>"><?php echo html_entity_decode($s['name']); ?></option>
                <?php } ?>
            ...
            <div class="col-md-12">
              <?php echo render_input('walkplace', 'walkplace', ''); ?>
            </div>
            <div class="col-md-6"> <?php
                                    $attr = array();
                                    $attr = ['data-type' => 'currency'];
                                    echo render_input('walk_time_from', 'starting_walk_time_from', '', 'text', $attr); ?></div>
            <div class="col-md-6"> <?php echo render_input('walk_time_to', 'starting_walk_time_to', '', 'text', $attr); ?></div>
            ...
            <div class="col-md-12"> <?php echo render_textarea('reason_appointment', 'reason_appointment', '') ?></div>
            <div class="col-md-12"> <?php echo render_textarea('sitter_description', 'sitter_description', '', array(), array(), '', 'tinymce') ?></div>

          </div>

          <div role="tabpanel" class="tab-pane" id="pet_after_request">
            ...
            <div class="col-md-12">
              <?php echo render_input('file', 'file_message', '', 'file') ?>
