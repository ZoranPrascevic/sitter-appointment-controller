<div class="panel_s">
   <div class="panel-body">
         ...
         ?>
            <div class="col-md-3 pull-right">
               <select name="change_status" id="change_status" onchange="change_status_campaign(this,<?php echo html_entity_decode($campaigns->cp_id); ?>); return false;" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('change_status_to'); ?>">
                  <option value=""></option>
                  <option value="1" class="<?php if ($campaigns->cp_status == 1) {
                                                echo 'hide';
                                             } ?>"><?php echo _l('planning'); ?></option>
                  <option value="3" class="<?php if ($campaigns->cp_status == 3) {
                                                echo 'hide';
                                             } ?>"><?php echo _l('in_progress'); ?></option>
                  <option value="4" class="<?php if ($campaigns->cp_status == 4) {
                                                echo 'hide';
                                             } ?>"><?php echo _l('finish'); ?></option>
                  <option value="5" class="<?php if ($campaigns->cp_status == 5) {
                                                echo 'hide';
                                             } ?>"><?php echo _l('cancel'); ?></option>
               </select>
            </div>
         <?php } ?>
         ...
         <table class="table border table-striped margin-top-0">
            <tbody>
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo get_rec_dpm_name($campaigns->cp_sitter_available_time); ?></td>
               </tr>
               <tr class="project-overview">
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo app_format_money($campaigns->cp_walk_time_from, '') . ' - ' . app_format_money($campaigns->cp_walk_time_to, ''); ?></td>
               </tr>
               <tr class="project-overview">
                  <td class="bold"><?php echo _l('reason_appointment'); ?></td>
                  <td><?php echo html_entity_decode($campaigns->cp_reason_appointment); ?></td>
               </tr>
               <tr class="project-overview">
         ...
         <table class="table table-striped margin-top-0">
            <tbody>
               ...
               <tr class="project-overview">
                  ...
                  <td><?php echo html_entity_decode($campaigns->cp_walkplace); ?></td>
               </tr>
      ...
      <div class="col-md-12 padding-left-10">
         <p class="bold text-muted"><?php echo _l('sitter_description') . ': ' . $campaigns->cp_sitter_description; ?></p>
      ...
      <div class="col-md-12" id="campaign_pv_file">
         ...
         if (count($campaign_file) > 0) {
            ...
            foreach ($campaign_file as $f) {
               $href_url = site_url(appointment_PATH . 'campaign/' . $f['rel_id'] . '/' . $f['file_name']) . '" download';
               if (!empty($f['external'])) {
