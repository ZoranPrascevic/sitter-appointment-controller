...
<div class="modal fade" id="appointment_campaign" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <?php echo form_open_multipart(admin_url('appointment/campaign'), array('id' => 'appointment-campaign-form')); ?>
      ...
      <div class="modal-body">
        ...
        <div class="tab-content">
          <div role="tabpanel" class="tab-pane active" id="general_infor">
            ...
            <div class="col-md-12">
              <label for="cp_message"><?php echo _l('appointment_message'); ?></label>
              <select name="cp_message[]" id="message" class="selectpicker" multiple="true" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">

                <?php foreach ($rec_message as $s) { ?>
                  <option value="<?php echo html_entity_decode($s['id']); ?>"><?php echo html_entity_decode($s['pet_name']); ?></option>
                <?php } ?>
              </select>
              <br><br>
            </div>
            ...
            <div class="col-md-6">
              ...
              <select name="cp_sitter_available_time" id="sitter_available_time" class="selectpicker" data-live-search="true" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>">
                <option value=""></option>
                <?php foreach ($sitter_available_times as $s) { ?>
                  <option value="<?php echo html_entity_decode($s['sitter_available_timeid']); ?>"><?php echo html_entity_decode($s['name']); ?></option>
                <?php } ?>
            ...
            <div class="col-md-12">
              <?php echo render_input('cp_walkplace', 'walkplace', ''); ?>
            </div>
            <div class="col-md-6"> <?php
                                    $attr = array();
                                    $attr = ['data-type' => 'currency'];
                                    echo render_input('cp_walk_time_from', 'starting_walk_time_from', '', 'text', $attr); ?></div>
            <div class="col-md-6"> <?php echo render_input('cp_walk_time_to', 'starting_walk_time_to', '', 'text', $attr); ?></div>
            ...
            <div class="col-md-12"> <?php echo render_textarea('cp_reason_appointment', 'reason_appointment', '') ?></div>
            <div class="col-md-12"> <?php echo render_textarea('cp_sitter_description', 'sitter_description', '', array(), array(), '', 'tinymce') ?></div>
            <div class="col-md-6">
