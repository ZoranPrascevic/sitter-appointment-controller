...
<div>
            ...
            <?php foreach ($list_set_tran as $li) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo admin_url('appointment/delete_setting_tranfer/' . $li['set_id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
    ...
    <div class="modal fade" id="setting_tranfer" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <?php echo form_open_multipart(admin_url('appointment/setting_tranfer')); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form">
                                ...
                                <select name="send_to" id="send_to" onchange="change_send_to(this); return false;" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('ticket_settings_none_assigned'); ?>" required>
                                    <option value=""></option>
                                    <option value="pet_after"><?php echo _l('successful_pet_afters'); ?></option>
                                    <option value="staff"><?php echo _l('staff'); ?></option>
                                    <option value="sitter_available_time"><?php echo _l('sitter_available_time'); ?></option>
                                </select>
                                <br><br>
