...
<div>
		...
		<tbody>
			<?php foreach ($list_form as $lf) { ?>
				<tr>
					...
					<td><?php if (get_rec_position_name($lf['position']) != '') {
							echo get_rec_position_name($lf['position']);
						} else {
							echo _l('all');
						} ?></td>
					...
					<td>
						<?php if (has_permission('appointment', '', 'edit') || is_admin()) { ?>
						...
						<?php if (has_permission('appointment', '', 'delete') || is_admin()) { ?>
							<a href="<?php echo admin_url('appointment/delete_evaluation_form/' . $lf['form_id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
						<?php } ?>
					</td>
				</tr>
			<?php } ?>
	...
	<div class="modal fade" id="evaluation_form" tabindex="-1" role="dialog">
		<div class="modal-dialog">
			<?php echo form_open(admin_url('appointment/evaluation_form')); ?>
						...
						<div class="col-md-12">
							...
							<div class="form">
								<div class="col-md-12">
									...
									<div id="select_sitterposition">
										<label for="sitterposition"><?php echo _l('sitterposition'); ?></label>
										<select name="sitterposition" id="sitterposition" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('all'); ?>">
											<option value=""></option>
