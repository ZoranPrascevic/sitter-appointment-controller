...
<div>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php if (has_permission('appointment', '', 'delete') || is_admin()) { ?>
                            <a href="<?php echo admin_url('appointment/delete_evaluation_criteria/' . $gr['criteria_id']); ?>" class="btn btn-danger btn-icon _delete"><i class="fa fa-remove"></i></a>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
    ...
    <div class="modal fade" id="evaluation_criteria" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <?php echo form_open(admin_url('appointment/evaluation_criteria')); ?>
